"""Test script for the linguistic analyzer."""
...
def test_basic_functionality():
    ...
    try:
        ...
        content = scraper.extract_text_content(test_url)
        print(f"   [OK] Successfully extracted {content['content_length']} characters")
        print(f"   Title: {content['title']}")
    except Exception as e:
        print(f"   [ERROR] Web scraper test failed: {e}")
